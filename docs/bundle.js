...
__WEBPACK_IMPORTED_MODULE_0_jquery___default()(document).ready(() => {
  function activateTop() {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.most-word').text(``);
    fetch('https://wordwatch-api.herokuapp.com/api/v1/top_word')
      .then(res => res.json())
      .then(response => {
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.most-word').text(`${Object.keys(response.word)}: ${Object.values(response.word)}`);
    });
  }
  ...
  function postThemWords() {
    __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.word-count').append("<br>")
    ...
    for (let word of wordArray) {
      ...
      .then(response => {
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.word-count').append(`<p>${response.message}</p><br>`);
      });
    };
    activateTop();
  };
...
exports.push([module.i, "@import url(https://fonts.googleapis.com/css?family=Faster+One);", ""]);
